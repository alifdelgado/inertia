<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="bg-white border-b border-gray-100">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <jet-responsive-nav-link :href="route('projects.index')" :active="route().current('projects')">
                        Projects
                    </jet-responsive-nav-link>
                </div>
        ...
        <header class="bg-white shadow">
            <div class="max-w-lg px-4 py-6 mx-auto sm:px-6 lg:px-8">
        ...
        <main>
            <div class="py-4" v-if="$page.flash.success">
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="relative px-4 py-3 text-green-700 bg-green-100 border-green-400 rounded" role="alert">
                        <span class="block sm:inline" v-text="$page.flash.success"></span>
                    </div>
                </div>
            </div>
            <slot></slot>
